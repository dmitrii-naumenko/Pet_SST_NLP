...
Бизнес-цель  - ранее выявление инцидентов в транспорте. Для реализации предлагается использовать звук переговоров машинистов. 
...
Нет. В зависимоси от NLP модели может быть токенизация и/или леммантизация.
